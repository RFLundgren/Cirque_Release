...
| Pulse insights | Pulse plugin plus compatible server/plugin support | Enables Pulse cards for weekly, monthly, and yearly listening recaps. |
...
Pulse is an optional insight system. It is separate from standard Navidrome and requires the Pulse plugin plus a compatible server/plugin path.
...
Mood breakdowns require mood playlists on the server. These can be created manually or generated by the AI mood playlist/tagging workflow.
